...
public class Day11Part1 {
    ...
    private static int getDistanceBetween(
        ...
        var rowExpansionBetween = rowsWithoutGalaxies.subSet(minRow, maxRow).size();
        var colExpansionBetween = colsWithoutGalaxies.subSet(minCol, maxCol).size();
        return Math.abs(gal1.row() - gal2.row()) + Math.abs(gal1.col() - gal2.col()) + rowExpansionBetween
                + colExpansionBetween;
    }
