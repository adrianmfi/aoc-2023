...
public class Day18Part2 {
    ...
    static long ringArea(Position[] ring) {
        long area = 0;
    ...
    static long cross(Position a, Position b) {
    ...
    record Instruction(Direction dir, long dist) {
        static Instruction of(String string) {
            ...
            var dist = Integer.parseInt(parts[2].substring(2, 7), 16);
            var dir = Direction.values()[Integer.parseInt(parts[2].substring(7, 8))];
